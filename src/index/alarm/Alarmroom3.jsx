...
const AlarmSettingsroom3 = () => {
  ...
  useEffect(() => {
    ...
    fetch('http://localhost:4002/get-threshold')
    ...
    fetch('http://localhost:4052/get-threshold')
      .then(response => response.json())
      .then(data => {
  ...
  const handleSaveSettings = () => {
    ...
    fetch('http://localhost:4002/set-threshold', {
      method: 'POST',
      headers: {
  ...
  const handleSaveTimeSettings = () => {
    ...
    fetch('http://localhost:4052/set-threshold', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
...
export default AlarmSettingsroom3;
