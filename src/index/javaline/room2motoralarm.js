...
const lineNotifyToken = 'ToWtGIxZVlid27EMjeVuo5cXWk1gVZwYq0cBR4RGdXY';
...
const checkTime = async () => {
  ...
  const fluxQuery = flux`from(bucket: "Room2")
                         |> range(start: -1h)
                         |> filter(fn: (r) => r._measurement == "Timer_motor1_onroom2")
